import {PRODUCT_LIST_SUCCESS,PRODUCT_LIST_REQUEST,PRODUCT_LIST_FAIL} from '../constants/productsConstants';
import {PRODUCT_DETAIL_SUCCESS,PRODUCT_DETAIL_REQUEST,PRODUCT_DETAIL_FAIL} from '../constants/productsConstants';
...
export const productsDetailReducer =(state={product:{reviews:[]}},action) =>{
    switch (action.type) {
        case PRODUCT_DETAIL_REQUEST:return {loading:true, products:[]}
